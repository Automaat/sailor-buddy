...
type Querier interface {
	...
	GetOrgVoyagesByYear(ctx context.Context, orgID sql.NullInt64) ([]GetOrgVoyagesByYearRow, error)
	...
	GetTripByEnrollToken(ctx context.Context, enrollToken sql.NullString) (GetTripByEnrollTokenRow, error)
	...
	ListCruiseTrips(ctx context.Context, cruiseID sql.NullInt64) ([]Trip, error)
	ListCruiseVoyages(ctx context.Context, cruiseID sql.NullInt64) ([]Voyage, error)
	...
	ListOrgTrips(ctx context.Context, orgID sql.NullInt64) ([]Trip, error)
	ListOrgVoyages(ctx context.Context, orgID sql.NullInt64) ([]Voyage, error)
