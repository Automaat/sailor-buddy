...
func NewOrgVoyagePortHandler(q sqlcdb.Querier) *OrgVoyagePortHandler {
	return &OrgVoyagePortHandler{q: q}
}
...
func RegisterOrgVoyagePortRoutes(api huma.API, q sqlcdb.Querier) {
	h := NewOrgVoyagePortHandler(q)
